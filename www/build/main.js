...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_img_viewer__ = __webpack_require__(294);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/maximilien/Project/ionic3-movie-app/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n'/*ion-inline-end:"/home/maximilien/Project/ionic3-movie-app/src/app/app.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/maximilien/Project/ionic3-movie-app/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <div class="pins">\n    <ion-card class="pin" *ngFor="let post of posts">\n      <img [src]="post.postImageUrl" imageViewer>\n      <div *ngIf="post.text" class="post-description">\n        <ion-icon id="like" name="heart"></ion-icon>\n        <small>{{ post.text }}</small>\n      </div>\n    </ion-card>\n  </div>\n\n  <div class="popup-menu">\n    <div class="popup-menu-overlay" [ngClass]="{\'in\': openMenu}" (click)="togglePopupMenu()"></div>\n    <div class="popup-menu-toggle" (click)="togglePopupMenu()" [ngClass]="{\'out\': openMenu}"></div>\n    <div class="popup-menu-panel" [ngClass]="{\'in\': openMenu}">\n      <div class="popup-menu-item" (click)="goToHome()">\n        <ion-icon name="home"></ion-icon>\n        <span>HOME</span>\n      </div>\n      <div class="popup-menu-item" (click)="goSearch()">\n        <ion-icon name="search"></ion-icon>\n        <span>SEARCH</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToProfile()">\n        <ion-icon name="ionitron"></ion-icon>\n        <span>PROFILE</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToFavoris()">\n        <ion-icon name="heart"></ion-icon>\n        <span>FAVORIS</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToAdd()">\n        <ion-icon name="add-circle"></ion-icon>\n        <span>ADD</span>\n      </div>\n  </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/maximilien/Project/ionic3-movie-app/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */]])
    ], HomePage);
    return HomePage;
...
var Add_ContentPage = /** @class */ (function () {
    function Add_ContentPage(navCtrl) {
        this.navCtrl = navCtrl;
        this.openMenu = false;
    }
    ...
    Add_ContentPage = Add_ContentPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/maximilien/Project/ionic3-movie-app/src/pages/add_content/add_content.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Add photo</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <h3>Photo</h3>\n\n  <div class="popup-menu">\n    <div class="popup-menu-overlay" [ngClass]="{\'in\': openMenu}" (click)="togglePopupMenu()"></div>\n    <div class="popup-menu-toggle" (click)="togglePopupMenu()" [ngClass]="{\'out\': openMenu}"></div>\n    <div class="popup-menu-panel" [ngClass]="{\'in\': openMenu}">\n      <div class="popup-menu-item" (click)="goToHome()">\n        <ion-icon name="home"></ion-icon>\n        <span>HOME</span>\n      </div>\n      <div class="popup-menu-item" (click)="goSearch()">\n        <ion-icon name="search"></ion-icon>\n        <span>SEARCH</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToProfile()">\n        <ion-icon name="ionitron"></ion-icon>\n        <span>PROFILE</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToFavoris()">\n        <ion-icon name="heart"></ion-icon>\n        <span>FAVORIS</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToAdd()">\n        <ion-icon name="add-circle"></ion-icon>\n        <span>ADD</span>\n      </div>\n    </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/maximilien/Project/ionic3-movie-app/src/pages/add_content/add_content.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */]])
    ], Add_ContentPage);
...
var FavorisPage = /** @class */ (function () {
    ...
    FavorisPage = FavorisPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-favoris',template:/*ion-inline-start:"/home/maximilien/Project/ionic3-movie-app/src/pages/favoris/favoris.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Favoris</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <div id="profile-bg" [ngStyle]="{\'background-image\': \'url(\' + user.coverImage +\')\'}"></div>\n\n    <div id="content">\n\n      <div id="profile-info" padding>\n        <img id="profile-image" [src]="user.profileImage">\n        <h3 id="profile-name">{{user.name}}</h3>\n        <p>{{user.occupation}} &bull; {{posts?.length}} </p>\n        <p class="profile-description">{{user.description}}</p>\n      </div>\n\n\n      <div *ngIf="size == 0" id="no-list-photo">\n        No photo <br> Think to add <br>\n        <button class="popup-menu-item" (click)="goToAdd()">\n          <ion-icon name="add-circle"></ion-icon>\n          <span>ADD</span>\n        </button>\n      </div>\n\n      <div class="pins">\n        <ion-card class="pin" *ngFor="let post of posts">\n          <img [src]="post.postImageUrl" imageViewer>\n          <div *ngIf="post.text" class="post-description">\n            <ion-icon id="like" name="heart"></ion-icon>\n            <small>{{ post.text }}</small>\n          </div>\n        </ion-card>\n      </div>\n    </div>\n\n  <div class="popup-menu">\n    <div class="popup-menu-overlay" [ngClass]="{\'in\': openMenu}" (click)="togglePopupMenu()"></div>\n    <div class="popup-menu-toggle" (click)="togglePopupMenu()" [ngClass]="{\'out\': openMenu}"></div>\n    <div class="popup-menu-panel" [ngClass]="{\'in\': openMenu}">\n      <div class="popup-menu-item" (click)="goToHome()">\n        <ion-icon name="home"></ion-icon>\n        <span>HOME</span>\n      </div>\n      <div class="popup-menu-item" (click)="goSearch()">\n        <ion-icon name="search"></ion-icon>\n        <span>SEARCH</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToProfile()">\n        <ion-icon name="ionitron"></ion-icon>\n        <span>PROFILE</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToFavoris()">\n        <ion-icon name="heart"></ion-icon>\n        <span>FAVORIS</span>\n      </div>\n      <div class="popup-menu-item" (click)="goToAdd()">\n        <ion-icon name="add-circle"></ion-icon>\n        <span>ADD</span>\n      </div>\n    </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/maximilien/Project/ionic3-movie-app/src/pages/favoris/favoris.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */]])
    ], FavorisPage);
    return FavorisPage;
